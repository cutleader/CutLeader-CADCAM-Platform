...
public:
	...
	*/
	...
	virtual BOOL IsBoundaryLoop() const = 0;
	virtual void IsBoundaryLoop(BOOL bBoundary) = 0;

	// whether this loop is "open path".
	...
	// about the cache data of the pattern loop.
	virtual void SetCacheData(PatternLoopCachePtr pPatternLoopCache) = 0;
	virtual PatternLoopCachePtr GetCacheData() const = 0;
};

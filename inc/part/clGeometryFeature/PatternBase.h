...
public: // implement IPattern interface.
	...
	virtual PatternRelationListPtr GetRelationByType(PatternRelationType patRelationType) const override;
	virtual PatternRelationListPtr GetPatternRelationList() const override { return m_pPatternRelations; }
	virtual void SetPatternRelationList(PatternRelationListPtr pPatternRelations) override;
	virtual void AddPatternRelation(PatternRelationPtr pPatternRelation) override;

	virtual IPatternPtr IsControlPat() const override;
	...
	virtual PatternCachePtr GetCacheData() const override { return m_pPatternCache; }

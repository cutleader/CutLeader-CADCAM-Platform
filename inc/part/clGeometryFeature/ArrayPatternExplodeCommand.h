...
{
public:
	ArrayPatternExplodeCommand(EditorData editorData, PatternListPtr pPatList, PatternLoopListPtr pPatternLoopList, IArrayPatternPtr pArrayPattern);
...
private:
	...
	// the control pattern of the array pattern.

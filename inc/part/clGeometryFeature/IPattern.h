...
public:
	...
	// set the relation list of this pattern.
	virtual void SetPatternRelationList(PatternRelationListPtr pPatternRelations) = 0;

	// add the relation to this pattern.
	virtual void AddPatternRelation(PatternRelationPtr pPatternRelation) = 0;

	// get the relations of the pattern through the relation type.
	virtual PatternRelationListPtr GetRelationByType(PatternRelationType patRelationType) const = 0;
	/************************************************************************/
	...
	virtual IPatternPtr IsControlPat() const = 0;
	...
	// 关于缓存数据。
	virtual PatternCachePtr GetCacheData() const = 0;

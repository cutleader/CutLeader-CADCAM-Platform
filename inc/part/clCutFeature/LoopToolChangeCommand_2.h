...
{
public:
	LoopToolChangeCommand_2(EditorData editorData, LoopToolDataListPtr pLoopToolList, ToolInstancePtr pToolInstance_new, LoopStartCutDataListPtr pLoopStaEndCutList, LeadConfigItemPtr pLeadConfigItem);

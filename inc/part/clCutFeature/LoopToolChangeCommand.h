...
{
public:
	LoopToolChangeCommand(EditorData editorData, LoopToolDataListPtr pLoopToolList, ToolInstancePtr pToolInstance_new, LoopStartCutDataListPtr pLoopStaEndCutList, LeadConfigItemPtr pLeadConfigItem);

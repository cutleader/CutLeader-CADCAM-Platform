...
#define IDS_PARTPMT_FROM_ASM_DXF			ClPartLayout_Resource_StartID+203
// "编辑零件布局"分组。
...
#define IDS_PARTPMT_FROM_ASM_DXF_TIP		ClPartLayout_Resource_StartID+252
// "编辑零件布局"分组。
...
#define IDC_PARTPMT_FROM_SGL_DXF			ClPartLayout_Resource_StartID+301
#define IDC_PARTPMT_FROM_ASM_DXF			ClPartLayout_Resource_StartID+302
#define IDC_PARTPMT_SELECT					ClPartLayout_Resource_StartID+303
...
#define WM_HideOrShowCutPath	            ClPartLayout_Resource_StartID+490

// 发送这个消息给板材视图，要求进入选择零件或者选择轮廓动作。
#define WM_EnterSelectPartPlacementOrLoopInstanceAction	    ClPartLayout_Resource_StartID+491 // 消息参数：1选择轮廓实例，2选择零件放置，3编辑器参考上一次选择的对象进行选择，这个消息不会预先选择对象。
#define WM_EnterSelectPartPlacementAction	                ClPartLayout_Resource_StartID+492 // 参数中携带要预先选中的零件放置ID集合的指针，消息接收者负责释放。
/************************************************************************/
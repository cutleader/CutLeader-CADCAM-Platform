...
// “微连接分配规则”。
class ClExpertLib_Export MicroJointConfigItem : public ClData,
...
public: // get/set functions.
	void SetRangeList(std::vector<MicroJointRangePtr> rangeList) { m_rangeList = rangeList; }
	std::vector<MicroJointRangePtr>* GetRangeList() { return &m_rangeList; }

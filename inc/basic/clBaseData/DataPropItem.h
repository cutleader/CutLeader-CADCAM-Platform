...
public:
	...
	DataPropItem(VARIANT& var);
	DataPropItem(int iItemName, VARIANT& var);
	DataPropItem(int iCatagoryName, int iItemName, VARIANT& var);

	// constructor for number-type item.
	/* params:
	*  iPrecision: the precision for float number.
	*/
	DataPropItem(int iCatagoryName, int iItemName, VARIANT& var, CString strFormat);
	DataPropItem(int iCatagoryName, int iItemName, VARIANT& var, int iPrecision);

	// constructor for option-type item.
	DataPropItem(int iCatagoryName, int iItemName, VARIANT& var, StringListPtr optsPtr);
...
public: // get/set functions.
	...
	void SetValue(VARIANT& v) { m_value = v; }
	VARIANT GetValue() const { return m_value; }
	/************************************************************************/

...
class ClBaseData_Export ProductItemLoader
{
public:
	/************************************************************************/
	// about get data prop.
	...
	*/
	...
	// notes:
	//   1) the path of data item is not set here.
	static DataItemPtr LoadDataItem(DBConnectPtr pDBConnect, LONGLONG iDataID);
};

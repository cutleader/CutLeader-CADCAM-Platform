...
public:
	...
	*/
	...
	bool GetLineStipple(bool& bStipple, int& iRepeat, unsigned short& iPattern);
	...
	// draw text.
	BOOL DrawText(CString str, double dLeftTopX, double dLeftTopY, double dRightBottomX, double dRightBottomY);
	/************************************************************************/


	// get the cursor position.
	void GetCursorPos(double& d1, double& d2);
...
private:
	// find from indexes.
	UCHAR FindFromIndex(int iIndex, UINT ibits, UINT iShift);

...
public:
	...
	*/
	...
	static Polygon2DListPtr BuildPolyListFromLineArc(LineArc2DListPtr pGeo2DList, double dCutArcFactor, BuildPolyFromArc_Policy iPolicy = BuildPolyFromArc_diffPolicy4DiffDirArc);
	/************************************************************************/

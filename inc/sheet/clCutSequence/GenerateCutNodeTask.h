...
{
public:
	GenerateCutNodeTask(Point2D startSeqPt, PartPlacementListPtr pPartPlacements, PartInstanceListPtr pPartInstances, CutSequenceListPtr pCutSequences, 

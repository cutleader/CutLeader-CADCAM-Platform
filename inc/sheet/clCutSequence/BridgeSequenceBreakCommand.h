...
public:
	BridgeSequenceBreakCommand(EditorData editorData, CutSequenceListPtr pCutSequences, ConfigDataPtr pConfigData, BridgeSequencePtr pBridgeSequence, BridgeNodePtr pBridgeNode);

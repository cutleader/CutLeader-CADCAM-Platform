...
public:
	...
	// 偏移“田字工序”。
	static GridCutSequencePtr ProcessOffset(GridCutSequencePtr pGridSeq, PartInstanceListPtr pPartInsts_after_offset);

	// 判断这个田字工序是不是有效。
	static BOOL IsGridSeqInvalid(GridCutSequencePtr pGridSeq, PartInstanceListPtr pAllPartInstances);

	// 根据新的“零件实例”集合更新“田字工序”中的一些数据。
	static void UpdateGridSeq(GridCutSequencePtr pGridSeq, PartInstanceListPtr pOldPartInsts, PartInstanceListPtr pNewPartInsts);
};

...
{
public:
	BridgeNodeAddCommand(EditorData editorData, CutSequenceListPtr pCutSequences, ConfigDataPtr pConfigData,
				   PartInstanceListPtr pPartInstances, BridgeSequencePtr pBridgeSequence, BridgeNodePtr pParentBdgeNode, BridgePtPtr pParentBridgePt, LoopInstancePtr pLoopInstance, BridgePtPtr pChildBdgePt);

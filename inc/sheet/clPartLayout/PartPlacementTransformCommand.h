...
public:
	...
	*/
	PartPlacementTransformCommand(CString str, EditorData editorData, PartPlacementListPtr pPartPlacements, PartPlacementListPtr pOldPartPmts,PartPlacementListPtr pNewPartPlacements);

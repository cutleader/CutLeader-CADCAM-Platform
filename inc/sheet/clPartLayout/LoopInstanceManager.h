...
public:
	...
	*/
	...
	static LineArc2DLoopListPtr LoopInsts_2_GeomLoops(LoopInstanceListPtr pLoopInstances);
	static LineArc2DLoopPtr LoopInst_2_GeomLoop(LoopInstancePtr pLoopInstance);

...
{
public:
	StartCutPt2CornerCommand(EditorData editorData, LoopStartCutDataListPtr pLoopStaEndCuts, ILoopStartCutPtPtr pLoopStartCutPt, ILeadPtr pLeadIn, ILeadPtr pLeadOut);

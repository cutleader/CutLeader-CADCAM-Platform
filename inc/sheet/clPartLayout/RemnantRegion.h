...
public: // get/set functions.
	...
	Rect2D GetOuterRect() const { return m_outerRect; }

	void SetHoleRegions(std::vector<std::tr1::tuple<Polygon2DPtr, Rect2D, double>> holeRegions) { m_holeRegions = holeRegions; }
	std::vector<std::tr1::tuple<Polygon2DPtr, Rect2D, double>> GetHoleRegions() const { return m_holeRegions; }
...
private:
	...
	// “区域内孔”。<区域内孔多边形，区域内孔外接矩形，形成这个内孔的零件外轮廓上面的刀具尺寸>
	std::vector<std::tr1::tuple<Polygon2DPtr, Rect2D, double>> m_holeRegions;

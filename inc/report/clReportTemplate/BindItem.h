...
typedef enum tagBindItemType
{
	...
	// basic info of nest job.
	BIND_ITEM_NESTJOB_NAME				= 310,
	BIND_ITEM_NESTJOB_COMMENT			= 311,
	BIND_ITEM_NESTJOB_CREATE_DATE		= 312,
	BIND_ITEM_NESTJOB_UTILIZATION		= 313,
	BIND_ITEM_NESTJOB_COST_TIME			= 314,
	/************************************************************************/

...
BOOL CMainFrame::OnCopyData(CWnd* pWnd, COPYDATASTRUCT* pCopyDataStruct) 
{
	...
	else if (pWndMsg->iWndMsgType == WNDMSG_ACTIVE_DOC)
	{
		...
		AfxGetApp()->PostThreadMessage(WM_OPEN_LIB, (WPARAM)pWndMsg->iDocNameRes, NULL);
...
void CMainFrame::InitializeRibbon()
{
	...
	// 帮助栏
	{
		...
		CMFCRibbonCategory* pHelpCategory = m_wndRibbonBar.AddCategory(str, IDB_UNDOREDO, IDB_HELP_BAR);

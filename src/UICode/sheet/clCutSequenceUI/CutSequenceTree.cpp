...
void CutSequenceTree::DisplaySeqUnitTree(CutSequenceListPtr pCutSequences)
{
	...
	/************************************************************************/
	// init "Loop Sequence Unit" sub node.
	...
	/************************************************************************/
	// init "Loop Grid Sequence Unit" sub node.
	...
	/************************************************************************/
	// init "Common Cutting Sequence Unit" sub node.
...
void CutSequenceTree::DeleteSelItems()
{
	...
	vector<HTREEITEM> selTreeItemList = GetSelTreeItem();
...
CutSequenceListPtr CutSequenceTree::GetSelCutSeqs()
{
	...
	vector<HTREEITEM> selectTreeNodes = GetSelTreeItem();

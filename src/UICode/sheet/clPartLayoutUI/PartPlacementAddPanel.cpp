...
BEGIN_MESSAGE_MAP(PartPlacementAddPanel, CDockablePane)
	ON_WM_CREATE()
	ON_WM_SIZE()
...
void PartPlacementAddPanel::DisplayPartList(PartLayoutEditorPtr pSheetEditor, ParamConfigPtr pParamConfig, FolderNodePtr pWorkspace)
{
	m_partAddDlg.DisplayPartList(pSheetEditor, pParamConfig, pWorkspace);
}

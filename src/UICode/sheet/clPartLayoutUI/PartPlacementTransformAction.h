...
{
public:
	PartPlacementTransformAction(IMaterialSizePtr pMaterialSize, PartPlacementListPtr pPartPlacementList, PartInstanceListPtr pPartInstanceList, PartGroupListPtr pPartGroups, DistanceDetectDlg* pDisDetectDlg, GlViewPortPtr pViewPort);

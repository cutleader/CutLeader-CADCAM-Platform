...
BEGIN_MESSAGE_MAP(LoopToolEditPanel, CDockablePane)
	ON_WM_CREATE()
	ON_WM_SIZE()
...
void LoopToolEditPanel::DisplayLoopToolInfo(const EditorData& editorData, LoopToolDataListPtr pLoopToolList, LoopStartCutDataListPtr pLoopStaEndCutList, LeadConfigItemPtr pLeadConfigItem,
										   ToolAssignConfigItemPtr pToolAssignConfigItem, ConditionTypeListPtr pCondTypeList)
{
	m_editorData = editorData;
	m_loopToolEditDlg.DisplayLoopToolInfo(pLoopToolList, pLoopStaEndCutList, pLeadConfigItem, pToolAssignConfigItem, pCondTypeList, GetEditorData());

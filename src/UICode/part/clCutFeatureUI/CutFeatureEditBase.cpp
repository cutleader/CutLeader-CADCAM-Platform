...
CutFeatureEditBase::CutFeatureEditBase(PatternListPtr pPatList, PatternLoopListPtr pPatternLoopList, LoopCutFeatureListPtr pLoopFeatureList, GlViewPortPtr pViewPort)
{
    m_pPatList = pPatList;

...
ArcPatternEditAction::ArcPatternEditAction(PatternListPtr pPatList, PatternLoopListPtr pPatternLoopList, GlViewPortPtr pViewPort)
{
...
{
	if (m_editState != EDIT_ARC_NOTSTART && !m_pPatList->GetPatternFromID(m_pGripEditPat->GetID()))
	{

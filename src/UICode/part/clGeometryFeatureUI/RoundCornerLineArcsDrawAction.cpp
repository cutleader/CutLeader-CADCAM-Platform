...
RoundCornerLineArcsDrawAction::RoundCornerLineArcsDrawAction(PatternListPtr pPatList, PatternLoopListPtr pPatternLoopList, GlViewPortPtr pViewPort)
{
	m_pPatList = pPatList;
...
void RoundCornerLineArcsDrawAction::CreateRCLinePat()
{
	...
	// create command
	ICommandPtr pCommand1(new PatternAddCommand(editorData, m_pPatList, m_pPatternLoopList, pArcPat1));
	pCommand1->Do();
	...
	// create command
	ICommandPtr pCommand2(new PatternAddCommand(editorData, m_pPatList, m_pPatternLoopList, pArcPat2));
	pCommand2->Do();
	...
	// create command
	ICommandPtr pCommand3(new PatternAddCommand(editorData, m_pPatList, m_pPatternLoopList, pArcPat3));
	pCommand3->Do();
	...
	// create command
	ICommandPtr pCommand4(new PatternAddCommand(editorData, m_pPatList, m_pPatternLoopList, pArcPat4));
	pCommand4->Do();
	...
	if (pLinePat1->GetLength() > GEOM_TOLERANCE)
	{
		...
		// create command
		ICommandPtr pCommand5(new PatternAddCommand(editorData, m_pPatList, m_pPatternLoopList, pLinePat1));
		pCommand5->Do();
	...
	if (pLinePat2->GetLength() > GEOM_TOLERANCE)
	{
		...
		// create command
		ICommandPtr pCommand6(new PatternAddCommand(editorData, m_pPatList, m_pPatternLoopList, pLinePat2));
		pCommand6->Do();
	...
	if (pLinePat3->GetLength() > GEOM_TOLERANCE)
	{
		...
		// create command
		ICommandPtr pCommand7(new PatternAddCommand(editorData, m_pPatList, m_pPatternLoopList, pLinePat3));
		pCommand7->Do();
	...
	if (pLinePat4->GetLength() > GEOM_TOLERANCE)
	{
		...
		// create command
		ICommandPtr pCommand8(new PatternAddCommand(editorData, m_pPatList, m_pPatternLoopList, pLinePat4));
		pCommand8->Do();

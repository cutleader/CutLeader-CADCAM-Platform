...
PatternLoopSelectAction::PatternLoopSelectAction(PatternLoopListPtr pPatternLoopList, GlViewPortPtr pViewPort)
{
...
BOOL PatternLoopSelectAction::DrawBeforeFinish()
{
	...
	if (m_pSelectedLoop)
	{
		...
		m_loopDrawerPtr->DrawPatternLoop(m_pSelectedLoop);
